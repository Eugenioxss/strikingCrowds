...
,p_group_id=>wwv_flow_imp.id(38796022997128418521)
,p_javascript_code_onload=>'apex.pwa.initPushSubscriptionPage();'
,p_step_template=>wwv_flow_imp.id(38677348458906478534)
,p_page_template_options=>'#DEFAULT#:js-dialog-class-t-Drawer--pullOutEnd'
,p_required_patch=>wwv_flow_imp.id(38875253623945248827)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38875254546497248828)
...
,p_plug_template=>wwv_flow_imp.id(38677379170997478549)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38875254946888248829)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38875254207561248828)
...
,p_button_redirect_url=>'f?p=&APP_ID.:20100:&APP_SESSION.::&DEBUG.:::'
,p_button_css_classes=>'t-Button--inlineLink'
,p_icon_css_classes=>'fa-chevron-left'
,p_grid_new_row=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38875255438126248829)
,p_name=>'P20020_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38875254946888248829)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38875255707788248830)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38875256261604248830)
,p_event_id=>wwv_flow_imp.id(38875255707788248830)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38875256788652248830)
,p_event_id=>wwv_flow_imp.id(38875255707788248830)
