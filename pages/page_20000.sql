...
,p_required_patch=>wwv_flow_imp.id(38796023383759418522)
,p_protection_level=>'C'
,p_help_text=>'This page contains a list of settings applicable to the current application user.'
,p_page_component_map=>'23'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38796027999334418527)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_plug_template=>wwv_flow_imp.id(38677617670143478566)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38796028312689418528)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(38677391490456478555)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(38796028839160418528)
,p_region_id=>wwv_flow_imp.id(38796028312689418528)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38796029366033418528)
,p_plug_name=>'Settings'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges:u-colors'
,p_plug_template=>wwv_flow_imp.id(38677384356336478551)
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(38796026939413418526)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(38677707669275478604)
);
